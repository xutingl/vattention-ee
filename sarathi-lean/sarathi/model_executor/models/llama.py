...
class LlamaDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        print("-------------------------------------")
        print(f"input hidden states after layer norm: {hidden_states}")
        ...
        print(f"output hidden states of attention: {hidden_states}")
        hidden_states = residual + hidden_states

        # Fully Connected
        residual = hidden_states
        hidden_states = self.post_attention_layernorm(hidden_states)
        print(f"hidden states before mlp: {hidden_states}")
        hidden_states = self.mlp(hidden_states)
        hidden_states = residual + hidden_states


        print(f"output hidden states: {hidden_states}\n")
...
class LlamaModel(nn.Module):
    ...
    def forward(
        ...
        print(f"---------------------\nBegining hidden states: {hidden_states}\n")
...
class LlamaForCausalLM(nn.Module):
    ...
    def forward(
        ...
        print(f"returning hidden states: {hidden_states}")
        return hidden_states
