...
class BaseLLMEngine:
    ...
    def step(self) -> List[RequestOutput]:
        ...
        return request_outputs, exited_rates, conf, conf_lst, is_ee, is_flush, is_prefill, latency_only_ee_iter_time, num_seq_would_ee_but_stay, num_seq_would_not_ee_but_ee
