...
class BaseWorker:
    ...
    def execute_model(
        ...
        sampler_outputs, output_seq_ids, updated_seq_metadata_list, exited_rates, conf_score, conf_lst, is_ee, is_flush, recompute_dict, latency_only_ee_iter_time, num_seq_would_ee_but_stay, num_seq_would_not_ee_but_ee, router_meta_map = self.model_runner.run(
            seq_metadata_list,
            self.gpu_cache,
        ...
        return sampler_outputs, output_seq_ids, seq_metadata_list, scheduler_outputs, exited_rates, conf_score, conf_lst, is_ee, is_flush, latency_only_ee_iter_time, num_seq_would_ee_but_stay, num_seq_would_not_ee_but_ee, router_meta_map
