...
class BaseWorker:
    ...
    def execute_model(
        ...
        sampler_outputs, output_seq_ids, updated_seq_metadata_list, exited_rates, conf_score, is_ee, ee_from_layer, is_flush_1, is_flush_2, recompute_dict, latency_only_ee_iter_time = self.model_runner.run(
            seq_metadata_list,
            self.gpu_cache,
        ...
        return sampler_outputs, output_seq_ids, seq_metadata_list, scheduler_outputs, exited_rates, conf_score, is_ee, ee_from_layer, is_flush_1, is_flush_2, latency_only_ee_iter_time #, self.cache_engine.num_free_blocks()
