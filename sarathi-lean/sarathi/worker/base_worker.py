...
class BaseWorker:
    ...
    def execute_model(
        ...
        sampler_outputs, output_seq_ids, updated_seq_metadata_list, exited_rates, conf_score, is_ee, is_flush, recompute_dict = self.model_runner.run(
            seq_metadata_list,
            self.gpu_cache,
        ...
        return sampler_outputs, output_seq_ids, seq_metadata_list, scheduler_outputs, exited_rates, conf_score, is_ee, is_flush #, self.cache_engine.num_free_blocks()
