...
python scripts/run_ee.py --ee_policy=latency-only --max_batch_size=4  --num_requests=100 --shallow_exit_layer=25 --conf_threshold=0.8 --csv_path="/workspace/xutingl/vattention-ee/outputs_13b/" --kv_method="copy" > outputs_13b/req_100_batch_4_conf_08_layer_25_latency_only.txt
...
nsys profile -t cuda -o nsight_profiles/rebatching_copy_nsight --python-sampling=true --python-sampling-frequency=2 python scripts/run_ee.py --ee_policy=rebatching --max_batch_size=2  --num_requests=4 --shallow_exit_layer=30 --conf_threshold=0.8 --csv_path="/workspace/xutingl/vattention-ee/outputs_13b_prof/" --kv_method="copy" > outputs_13b_prof/req_4_batch_2_layer_30_conf_08_rebatching.txt