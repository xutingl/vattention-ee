...
python scripts/run_ee.py --ee_policy=rebatching --max_batch_size=4  --num_requests=100 --shallow_exit_layer=24 --conf_threshold=0.9 --csv_path="/workspace/xutingl/vattention-ee/outputs_13b/" --kv_method="copy" > outputs_13b/req_100_batch_4_conf_09_layer_24_rebatching_copy.txt
